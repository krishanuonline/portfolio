      ...
      <div className="w-full max-w-6xl mx-auto z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <motion.div 
            ...
            initial="hidden"
            animate="visible"
            className="order-2 lg:order-1 flex flex-col gap-8 text-center lg:text-left"
          >
            ...
            <motion.div variants={fadeInUp} className="flex flex-col sm:flex-row items-center lg:justify-start justify-center gap-6 mt-2">
              <motion.button 
                ...
                whileTap={{ scale: 0.95 }}
                className="flex items-center justify-center h-14 px-8 rounded-2xl bg-primary text-white text-base font-bold transition-colors shadow-lg shadow-primary/20"
              >
            ...
            <div className="relative group">
              ...
              >
                ...
                <motion.div 
                  ...
                  transition={{ delay: 1 }}
                  className="absolute bottom-8 left-8 z-20 flex items-center gap-3 bg-surface/80 backdrop-blur-xl border border-white/10 p-4 rounded-2xl shadow-2xl"
                >
